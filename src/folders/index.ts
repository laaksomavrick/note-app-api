...
import { validateFolderBelongsToUser, validateFolderInputForCreate, validateFolderInputForUpdate } from "./middlewares";
...
export default (core: Core): ((app: Express) => void) => {
    return (app: Express): void => {
        ...
        app.post("/users/:userId/folders", authorize, isUser, validateFolderInputForCreate, create(core));
        app.patch(
